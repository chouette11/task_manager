...
class _$GetUpStateTearOff {
  ...
  _GetUpState call({TimeOfDay? getUpTime = null}) {
    return _GetUpState(
      getUpTime: getUpTime,
    );
  }
...
/// @nodoc
mixin _$GetUpState {
  TimeOfDay? get getUpTime => throw _privateConstructorUsedError;
...
abstract class _GetUpState implements GetUpState {
  const factory _GetUpState({TimeOfDay? getUpTime}) = _$_GetUpState;

  @override
  TimeOfDay? get getUpTime;
  @override
  @JsonKey(ignore: true)
  _$GetUpStateCopyWith<_GetUpState> get copyWith =>
      throw _privateConstructorUsedError;
